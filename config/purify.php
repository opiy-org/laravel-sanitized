    ...
    */
    'settings' => [
        ...
        */
        ...
        'HTML.Allowed' => 'h1[class],h2[class],h3[class],h4[class],h5[class],h6[class],' .
            'b[class],strong,i[class],em,' .
            'a[href|class|title],ul[class],ol[class],li[class],' .
            'p[class],br,span[class],' .
            'img[src|alt|class|title],table[summary|class],tr[class],td[class|abbr]',
        ...
        */
        ...
        'HTML.ForbiddenElements' => 'script,object,iframe',
